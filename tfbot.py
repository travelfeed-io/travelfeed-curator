...
def write_comment(post, commenttext, isTfio=False):
    ...
    if (isTfio):
        ...
        commenttext += "\n\nDid you know that you get larger upvotes when posting through <a href='https://travelfeed.io/'>TravelFeed.io</a>? Also, thanks to the travel writing contest by <a href='https://travelfeed.io/@invisusmundi'>@invisusmundi</a> you can now earn up to 100 STEEM on top of the post rewards when posting through our new platform <a href='https://travelfeed.io/'>TravelFeed.io</a>!"
    commenttext += " <a href='https://steempeak.com/travel/@invisusmundi/travelfeed-io-travel-writing-contest-no5'>Read the contest announcement</a> for more information on how to participate. \n\n We are continuously working on improving TravelFeed, recently we <a href='https://travelfeed.io/@travelfeed/travelfeed-at-steemfest-android-app-vote-for-our-witness'>presented at SteemFest⁴, published our Android app and launched our Steem witness</a>. \n\n Please consider voting for us as a witness. If you're not sure how to do that, it's easy: Head over to our **[Support Us](https://travelfeed.io/about/support-us)** page and hit the witness voting button to vote with Steem Keychain, or Steemconnect if you are not a Keychain user. Alternatively, use this [Steemconnect link](https://beta.steemconnect.com/sign/account-witness-vote?witness=travelfeed&redirect_uri=https%3A%2F%2Ftravelfeed.io%2Fwitnessvote%2Fsuccess) or head over to the [Steemit Wallet](https://steemitwallet.com/~witnesses) and enter travelfeed in the box. \n\n<center> [![](https://ipfs.busy.org/ipfs/QmZhLuw8WE6JMCYHD3EXn3MBa2CSCcygvfFqfXde5z3TLZ)](https://travelfeed.io/@travelfeed/introducing-travelfeed-beta)\n **Learn more about TravelFeed by clicking on the banner above and join our community on [Discord](https://discord.gg/jWWu73H)**.</center>"
