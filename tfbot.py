...
def write_comment(post, commenttext, isTfio=False):
    ...
    if not (isTfio):
        ...
        commenttext += "Don't forget to participate in the TravelFeed.io travel writing contest by <a href='https://travelfeed.io/@invisusmundi'>@invisusmundi</a> for a chance to win up too 100 STEEM!"
