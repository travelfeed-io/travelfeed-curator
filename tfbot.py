...
def write_comment(post, commenttext, isTfio=False):
    ...
    if not (isTfio):
        commenttext += "\n\nWe noticed that you did not post this post through <a href='https://travelfeed.io/'>TravelFeed.io</a> or edited your post with another Steem app. Did you know that you get larger upvotes when posting through <a href='https://travelfeed.io/'>TravelFeed.io</a>? Posting through <a href='https://travelfeed.io/'>TravelFeed.io</a> also gives you a chance to earn extra rewards from being featured in our daily topic curation posts. Also, thanks to the travel writing contest by <a href='https://travelfeed.io/@invisusmundi'>@invisusmundi</a> you can now earn up to 100 STEEM on top of the post rewards when posting through our new platform <a href='https://travelfeed.io/'>TravelFeed.io</a>!"
    else commenttext += "Don't forget to participate in the TravelFeed.io travel writing contest by <a href='https://travelfeed.io/@invisusmundi'>@invisusmundi</a> for a chance to win up too 100 STEEM!"
    commenttext += " <a href='https://steempeak.com/@invisusmundi/travelfeed-io-travel-writing-contest-no6'>Read the contest announcement</a> for more information on how to participate. \n\n We are continuously working on improving TravelFeed, recently we <a href='https://travelfeed.io/@travelfeed/updates-first-witness-block-instagram-embeds-and-awesome-easyeditor'>enabled Instagram embeds and made improvements to our EasyEditor</a>.\n\n<center> [![](https://ipfs.busy.org/ipfs/QmZhLuw8WE6JMCYHD3EXn3MBa2CSCcygvfFqfXde5z3TLZ)](https://travelfeed.io/@travelfeed/introducing-travelfeed-beta)\n **Learn more about TravelFeed by clicking on the banner above and join our community on [Discord](https://discord.gg/jWWu73H)**.</center>"
...
def process_post(post):
    ...
    if author in blacklist:
        ...
        elif post['tags'].index('travelfeed') > 5:
